...
depthlim = [borders[2] - 20.0, borders[4] + 10.0]
...
ax[0].set_title('t = ' + str(round(t/86400, 1)) + ' сут.')
ax[0].invert_yaxis()
...
ax[1].set_title('t = ' + str(round(t/86400, 1)) + ' сут.')
ax[1].invert_yaxis()
...
ax[2].set_title('t = ' + str(round(t/86400, 1)) + ' сут.')
ax[2].invert_yaxis()
